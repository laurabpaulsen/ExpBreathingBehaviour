...
class LeftRightTactileDiscriminationTask(Experiment):
    def __init__(
            self, 
...
if __name__ == "__main__":
    ...
    connectors = {
        ...
        "left": SGCFakeConnector(intensity_codes_path=Path("intensity_code.csv"), start_intensity=1),
    ...
    experiment = LeftRightTactileDiscriminationTask(

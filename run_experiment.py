...
if __name__ == "__main__":
    ...
    experiment = MiddleIndexTactileDiscriminationTask(
        ...
        break_sound_path=Path("/Users/au661930/Library/CloudStorage/OneDrive-Aarhusuniversitet/Dokumenter/projects/_BehaviouralBreathing/code/ExpBreathingBehaviour/utils/sound.wav")
    )
